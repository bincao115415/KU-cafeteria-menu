...
**Goal:** Deliver a Korean/Chinese/English weekly cafeteria menu HTML email to `bincao115415@gmail.com` every Monday by 11:30 KST, scraping all six Korea University cafeteria pages and using MiniMax LLM + web-search for first-time dish translations with two-pass verification.
  ...
  run:
    ...
    steps:
      ...
      - name: Run pipeline
        ...
        run: |
          git config user.email "bincao115415@gmail.com"
...
- Check the email inbox for `bincao115415@gmail.com`: HTML email with 6 cafeterias, correct translations, source links.
