...
- **Date**: 2026-04-20
- **Author**: bincao115415@gmail.com
- **Status**: Draft v1 — awaiting user review

## 1. Purpose

Automatically deliver a translated (Korean → Chinese + English), well-formatted HTML email of **the weekly menus for all six Korea University cafeterias** to `bincao115415@gmail.com` every Monday by 11:30 KST. The user reads Chinese and English but not Korean.
